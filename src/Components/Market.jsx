...
function Market() {
  return (
    <>
      <section className=" bg_navyblue  py-5">
        <div className=" container">
          ...
          <div className="row align-items-center mt-5 pt-5">
            <div className="col-lg-5">
              ...
              <p className=" ff_rubik fw-normal fs_16 color_light_gray my-4 mx_408">
            ...
            <div className=" mt-3 mt-lg-0 col-lg-7">
              <div className="bitcoin_box position-relative ">
                ...
                <div className="d-none d-sm-flex ">
                  <div className="box1 box1_pos  d-inline-block">
                    ...
                    <a
                      className=" text-decoration-none ff_inter fs_16 fw-normal color_gray_2"
                      href="#"
                    >
                      Sell option
                    </a>
                ...
                <div className=" d-flex justify-content-between align-items-center">
                  <div className=" d-flex gap-3 align-items-center">
                    ...
                    <article>
                      ...
                      <article className="d-flex gap-1 align-items-center ">
                        <p className=" ff_inter text-white fw-bold fs_4 mb-0">
                          Bitcoin
                        </p>
                  ...
                  <p className=" ff_inter fw_16 fw_500 color_light_blue">
                    +125%
                  </p>
                </div>
              ...
              <div className=" mt-3 d-flex justify-content-center">
                <div className="box1 d-sm-none   d-inline-block">
                  <p className=" ff_inter mx_146 fw-semibold fs_20 text-white mb-0">
                    Increase in Trade
                  </p>
                  <div className=" my-3 d-flex align-items-center">
              ...
              <div className=" d-flex justify-content-center">
                <div className=" d-sm-none d-inline-block mt-3   text-center box2">
                  <p className=" ff_inter fw-bold fs_20 text-white mb-0">
                    $15.32
                  </p>
                  <p className=" ff_inter fw-normal mb-0 fs_16 color_gray_2">
